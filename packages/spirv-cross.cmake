ExternalProject_Add(spirv-cross
    ...
    GIT_TAG main
    UPDATE_COMMAND ""
    PATCH_COMMAND ${EXEC} git checkout -f && git apply --ignore-space-change --ignore-whitespace ${CMAKE_CURRENT_SOURCE_DIR}/spirv-cross-0001-static-linking-hacks.patch
